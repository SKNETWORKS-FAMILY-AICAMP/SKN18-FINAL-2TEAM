...
def main():
    ...
    parser.add_argument(
        "--ts-meta",
        type=Path,
        default=Path("C:/dev/SKN_Final_Project_Team2/SKN18-FINAL-2TEAM/infra/neo4j/import/ts_section_meta_new.csv"),
        help="Path to ts_section_meta_new.csv",
    )
    parser.add_argument(
        "--chunks",
        type=Path,
        default=Path("C:/dev/SKN_Final_Project_Team2/SKN18-FINAL-2TEAM/infra/neo4j/import/ts_embedding_v2.csv"),
        help="Path to chunk vector CSV (chunk_id, section_id, text_chunk, embedding, ...)",
    )
    parser.add_argument(
        "--mentions",
        type=Path,
        default=Path("C:/dev/SKN_Final_Project_Team2/SKN18-FINAL-2TEAM/infra/neo4j/import/global_mention_master.csv"),
