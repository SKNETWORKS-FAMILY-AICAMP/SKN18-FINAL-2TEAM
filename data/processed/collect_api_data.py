...
while True:
    ...
    for i, proto_item in enumerate(protocols):
        ...
        abstract_html = parse_table_to_text(abstract_html)   # ★ 표 파싱
        ...
        for s in steps_list:
            ...
            step_html = parse_table_to_text(step_html)       # ★ 표 파싱
        ...
        reference_html = parse_table_to_text(reference_html)  # ★ 표 파싱
        ...
        guidelines_html = parse_table_to_text(guidelines_html)  # ★ 표 파싱
        ...
        materials_html = parse_table_to_text(materials_html)    # ★ 표 파싱
