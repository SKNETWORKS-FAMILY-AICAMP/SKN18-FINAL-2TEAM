...
window.Graph = GraphologyGraph; // paper_graph_modal.js에서 사용하는 이름
window.graphology = { Graph: GraphologyGraph }; // graphology 객체로도 노출
window.forceAtlas2 = forceAtlas2;
window.GraphologyLayout = { circular, forceAtlas2 };
window.graphologyLayout = { circular, forceAtlas2 }; // graphologyLayout 객체로도 노출
window.clsx = clsx;
